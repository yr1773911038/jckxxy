...
<html>
	<head>
		<meta charset="UTF-8" />
		<title>聊城中小企业公共服务平台 <?php echo L('ADMIN_CENTER');?></title>
		<meta http-equiv="X-UA-Compatible" content="chrome=1,IE=edge" />
		<meta name="renderer" content="webkit|ie-comp|ie-stand">
		<meta name="robots" content="noindex,nofollow">
		<link href="/lcservice/admin/themes/simplebootx/Public/assets/css/admin_login.css" rel="stylesheet" />
		<style>
			#login_btn_wraper{
				text-align: center;
			}
...
<body>
	<div class="wrap">
		<h1><a href="/lcservice">聊城中小企业公共服务平台 <?php echo L('ADMIN_CENTER');?></a></h1>
...
var GV = {
	DIMAUB: "",
	JS_ROOT: "/lcservice/public/js/",//js版本号
	TOKEN : ''	//token ajax全局
};
</script>
