  ...
  <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
    ...
    <li class="am-dropdown" data-am-dropdown>
        ...
        <ul class="am-dropdown-content">
          <li><a href="<?php echo U('user/index/up_userinfo');?>"><span class="am-icon-user"></span> 资料</a></li>
  ...
  <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list">
        <li><a href="<?php echo U('user/index/index');?>"><span class="am-icon-home"></span> 系统导航</a></li>
        <li><a href="<c:url value='/'/>news?operation=query" class="am-cf"><span class="am-icon-check"></span> 企业服务</a></li>
        <li><a href="<c:url value='/'/>imgnews?operation=query"><span class="am-icon-th"></span>  企业请求</a></li>
      </ul>
