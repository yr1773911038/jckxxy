...
<div class="top" id="top">
  <div class="container" id="summary-container">
   <div class="row" style="margin-top: 20px; margin-bottom: 10px;">
    <div class="col-sm-8" >
      <img src="/lcservice/themes/simplebootx/Public/images/img/fl2z.png" class="img-responsive abc" alt="Responsive image">
    </div>
     <div class="col-sm-4">
    ...
    <nav class="navbar navbar-default" role="navigation" style="margin-bottom: 0px;">
        <div class="container-fluid">
          ...
          <div class="navbar-collapse" id="bs-example-navbar-collapse-1">
              <?php
 $effected_id=""; $filetpl="<a href='\$href' target='\$target'>\$label</a>"; $foldertpl="<a href='\$href' target='\$target' class='dropdown-toggle' data-toggle='dropdown'>\$label <b class='caret'></b></a>"; $ul_class="dropdown-menu" ; $li_class="" ; $style="nav navbar-nav li"; $showlevel=6; $dropdown='dropdown'; echo sp_get_menu("7",$effected_id,$filetpl,$foldertpl,$ul_class,$li_class,$style,$showlevel,$dropdown); ?>
    ...
    <div class="row">
     ...
     <div class="col-sm-5">
        <ul class="nav nav-tabs" role="tablist" id="myTab">
            <a href="#"style="float: left;font-size: 17px;font-family:宋体;font-weight:bold;">法界热点</a>
            <a href="#" style="float: right;font-size: 17px">更多>></a>
        </ul>
           <div class="tab-pane active" id="home">
              <div class="info">
          <?php $lists = sp_sql_posts_paged("cid:6;order:post_date DESC;",7); ?>
                  <ul>
      ...
      <div class="col-sm-4 wenz">
           <div class="neir row1">
            <div class="neirong1"><a href="#" class="n1a">服务公告</a></div>
            <div class="neirong2"><a href="#" class="n2a">更多>></a></div>
           </div>
              <div class="neiro row2">
                <?php $lists = sp_sql_posts_paged("cid:7;order:post_date DESC;",7); ?>
                <ul class="ul1">
                <?php if(is_array($lists['posts'])): $i = 0; $__LIST__ = $lists['posts'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; $smeta=json_decode($vo['smeta'], true); ?>
     ...
     <div class="col-sm-4 wenz">
       ...
       <div class="neir row1">
            ...
            <div class="neir"class="neirong2"><a href="#" class="n2a">更多>></a></div>
           </div>
              <div class="neiro row2">
