...
<html lang="zh-CN">
	...
	<head>
        ...
        <title>担保服务平台</title>
        <style>
        .navbar .navbar-collapse .nav li{width:10%;}
        </style>
	</head>
...
<div class="top" id="top">
  <div class="container" id="summary-container">
   <div class="row" style="margin-top: 20px; margin-bottom: 10px;">
    <div class="col-sm-8">
      <img src="/lcservice/themes/simplebootx/Public/images/img/fl2.png" class="img-responsive abc" alt="Responsive image">
    </div>
    ...
    <nav class="navbar navbar-default" role="navigation" style="margin-bottom: 0px;">
        <div class="container-fluid">
          ...
          <div class="navbar-collapse" id="bs-example-navbar-collapse-1">
              <?php
 $effected_id=""; $filetpl="<a href='\$href' target='\$target'>\$label</a>"; $foldertpl="<a href='\$href' target='\$target' class='dropdown-toggle' data-toggle='dropdown'>\$label <b class='caret'></b></a>"; $ul_class="dropdown-menu" ; $li_class="" ; $style="nav navbar-nav li"; $showlevel=6; $dropdown='dropdown'; echo sp_get_menu("6",$effected_id,$filetpl,$foldertpl,$ul_class,$li_class,$style,$showlevel,$dropdown); ?>
      ...
      <iframe width="450" scrolling="no" height="20" frameborder="0" allowtransparency="true" src="http://i.tianqi.com/index.php?c=code&id=1&icon=4&py=liaocheng&wind=0&num=2"></iframe>
       ...
       <div class="col-md-offset-8" style="width: 80%; padding-left: 10%;">
		...
		<div class="container head" id="head">
				...
				<div class="col-sm-5 col-md-5">
					<ul class="nav nav-tabs" role="tablist" id="myTab">
						<a href="#" style="float: left;font-size: 17px;font-family:宋体;font-weight:bold;">
							<?php $parent=41; $res=getyousub($parent); print_r($res['name']); ?>
							<!--法界热点-->
						</a>
			...
			<div class="row">
				<?php $parent=42; $list=get_con($parent); ?>
