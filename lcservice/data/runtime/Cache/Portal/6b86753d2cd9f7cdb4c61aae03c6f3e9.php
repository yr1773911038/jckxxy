...
<html lang="zh-CN">
	<head>
		...
		<style>
			.navbar .navbar-collapse .nav li{width:12%;}
		</style>
	</head>
...
<div class="top" id="top">
	<div class="container" id="summary-container">
		<div class="row">
			<div class="col-sm-8">
				<img src="/lcservice/themes/simplebootx/Public/images/img/fl2.gif" class="img-responsive abc" alt="Responsive image">
			</div>
			<div class="col-sm-4">
		...
		<nav class="navbar navbar-default" role="navigation" style="margin-bottom: 0px;">
			<div class="container-fluid">
				...
				<div class="navbar-collapse" id="bs-example-navbar-collapse-1">
					<?php
 $effected_id=""; $filetpl="<a href='\$href' target='\$target'>\$label</a>"; $foldertpl="<a href='\$href' target='\$target' class='dropdown-toggle' data-toggle='dropdown'>\$label <b class='caret'></b></a>"; $ul_class="dropdown-menu" ; $li_class="" ; $style="nav navbar-nav li"; $showlevel=6; $dropdown='dropdown'; echo sp_get_menu("8",$effected_id,$filetpl,$foldertpl,$ul_class,$li_class,$style,$showlevel,$dropdown); ?>
	...
	<div class="weather" style="background:#F7F7F6 ">
		<div class="container">
			...
			<div class="col-md-offset-8" style="clear:both;width:75%; padding-right: 5%;">
		...
		<div class="container head" id="head">
				...
				<div class="col-sm-5 col-md-5">
					<ul class="nav nav-tabs" role="tablist" id="myTab">
						<a href="#" style="float: left;font-size: 17px;font-family:宋体;font-weight:bold;">
							<?php $parent=28; $res=getyousub($parent); print_r($res['name']); ?>
							<!--法界热点-->
						</a>
			...
			<div class="row">
				<?php $parent=29; $list=get_con($parent); ?>
