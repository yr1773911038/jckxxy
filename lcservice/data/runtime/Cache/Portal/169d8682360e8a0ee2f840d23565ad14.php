...
<head>
	...
	<link href="/lcservice/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/theme.min.css" rel="stylesheet">
    <link href="/lcservice/public/simpleboot/css/simplebootadmin.css" rel="stylesheet">
    <link href="/lcservice/public/js/artDialog/skins/default.css" rel="stylesheet" />
    <link href="/lcservice/public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
    <style>
	...
	<!--[if IE 7]>
	<link rel="stylesheet" href="/lcservice/public/simpleboot/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
	<![endif]-->
...
<!-- Le javascript
    ...
    <script src="/lcservice/public/simpleboot/bootstrap/js/bootstrap.min.js"></script>
...
<body>
							...
							<td>
								<div style="text-align: center;">
									...
									<a href="javascript:void(0);" onclick="flashupload('thumb_images', '附件上传','thumb',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','','','');return false;">
										<img src="/lcservice/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png" id="thumb_preview" width="135" style="cursor: hand" />
									</a>
									<input type="button" class="btn btn-small" onclick="$('#thumb_preview').attr('src','/lcservice/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png');$('#thumb').val('');return false;" value="取消图片">
								</div>
							</td>
						</tr>
						<tr>
	...
	<script type="text/javascript" src="/lcservice/public/js/common.js"></script>
	<script type="text/javascript" src="/lcservice/public/js/content_addtop.js"></script>
	<script type="text/javascript">
		//编辑器路径定义
		var editorURL = GV.DIMAUB;
	</script>
	<script type="text/javascript" src="/lcservice/public/js/ueditor/ueditor.config.js"></script>
	<script type="text/javascript" src="/lcservice/public/js/ueditor/ueditor.all.min.js"></script>
	<script type="text/javascript">
		$(function() {
