...
<html>
	<head>
		...
		<link href="/cmf/admin/themes/simplebootx/Public/assets/css/admin_login.css" rel="stylesheet" />
		<style>
			#login_btn_wraper{
				text-align: center;
			}
...
<body>
	<div class="wrap">
		<h1><a href="/cmf"><!-- ThinkCMF <?php echo L('ADMIN_CENTER');?> --></a></h1>
