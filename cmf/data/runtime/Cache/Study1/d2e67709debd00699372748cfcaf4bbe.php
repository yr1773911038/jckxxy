...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a>学生信息查询</a></li>
			<li><a href="<?php echo U('Study1/Index/add');?>">新增</a></li>
		</ul>
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
						...
						<td><?php echo ($vo["nl"]); ?></td>  
						<td><?php echo ($vo["xx"]); ?></td>
						<td><?php echo ($vo["jj"]); ?></td>
						<td align="center">
						 	<a href="<?php echo U('Study1/Index/edit',array('id'=>$vo['id']));?>">修改</a>
						</td>
