...
.eidt_uphoto .no {
    background: url("/cmf/admin/themes/simplebootx/Public/assets/images/upload_pic.jpg") no-repeat scroll center center #FBFBFB;
    border: 1px solid #CCCCCC;
    height: 98px;
    overflow: hidden;
    text-indent: -2000em;
...
.eidt_uphoto .del{
	...
	width:15px;
	height:15px;
	background:url("/cmf/admin/themes/simplebootx/Public/assets/images/upload_del.png") no-repeat;
	right:1px;
	top:1px;
	overflow:hidden;
	text-indent:-2000em;
...
/*上传选择按钮*/
#btupload,.addnew{
	background: url("/cmf/public/js/swfupload/images/swfBnt.png") no-repeat; float:left; margin-right:10px;width:75px; height:28px; line-height:28px;font-weight:700; color:#fff;
}
#btupload{ 
...
var swfu = '';
	$(document).ready(function(){
		Wind.use("swfupload",GV.DIMAUB+"public/js/swfupload/handlers.js",function(){
		      swfu = new SWFUpload({
			flash_url:"/cmf/public/js/swfupload/swfupload.swf",
