...
<body>
	<div class="wrap J_check_wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Companyadmin/index');?>">开发商管理</a></li>
			<li><a href="<?php echo U('Companyadmin/add');?>">添加开发商</a></li>
		</ul>
                <form action="<?php echo U('Companyadmin/search');?>" method="post" id="form">
                        <input type="text" name="dwqc1" value="" class="input" id="dwqc1" style="width:200px" placeholder="请输入开发商名称"> 
                        <button type="submit" class="btn btn-primary btn_submit  J_ajax_submit_btn">查询</button>
                </form>
		<form name="myform" action="<?php echo U('Companyadmin/index');?>" method="post">
			<table class="table table-hover table-bordered">
				<thead>
					<tr>
						<th width="30">ID</th>
						<th align="left">开发商名称</th>
						<th align="left">开发商描述</th>
				...
				<tbody>
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
						...
						<td> 
								<a href="<?php echo U('Companyadmin/edit',array('id'=>$vo['id']));?>">修改</a>| 
							<a class="J_ajax_del" href="<?php echo U('Companyadmin/delete',array('id'=>$vo['id']));?>">删除</a>
