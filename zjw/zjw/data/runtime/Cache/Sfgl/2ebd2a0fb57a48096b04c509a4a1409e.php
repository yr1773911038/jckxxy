...
<body>
	<div class="wrap J_check_wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Enregisteradmin/index');?>">上访登记管理</a></li>
			<li><a href="<?php echo U('Enregisteradmin/add');?>">上访登记</a></li>
      		<!--<li><a href="<?php echo U('Enregisteradmin/importExcel');?>">批量导入上访登记</a></li>-->
		</ul>
                <form action="<?php echo U('Enregisteradmin/search');?>" method="post" id="form">
                        <input type="text" name="xm1" value="" class="input" id="xm1" style="width:200px" placeholder="请输入上访人姓名"> 
                        <button type="submit" class="btn btn-primary btn_submit  J_ajax_submit_btn">查询</button>
                </form>
		<form name="myform" action="<?php echo U('Enregisteradmin/index');?>" method="post">
			<table class="table table-hover table-bordered">
				<thead>
					<tr>
						...
						<th width="40" align="left">是否处理</th>
                        <th width="40" align="left">是否结清</th>
						<th width="80">操作</th>
					</tr>
				</thead>
				<tbody>
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
						...
						<td> 
								<a href="<?php echo U('Enregisteradmin/edit',array('kh'=>$vo['id']));?>">查看</a> | 
							<a class="J_ajax_del" href="<?php echo U('Enregisteradmin/delete',array('id'=>$vo['id']));?>">删除</a>
