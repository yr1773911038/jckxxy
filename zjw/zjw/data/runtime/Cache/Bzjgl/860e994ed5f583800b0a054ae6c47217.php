...
<body>
	<div class="wrap J_check_wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Shadmin/index');?>">开发商保证金审核</a></li>
		</ul>
		<form name="myform" action="<?php echo U('Shadmin/index');?>" method="post">
			<table class="table table-hover table-bordered">
				...
				<tbody>
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
						...
						<td> 
								<a href="<?php echo U('Shadmin/shcg',array('id'=>$vo['id']));?>">审核通过</a> | 
							<a  href="<?php echo U('Shadmin/shsb',array('id'=>$vo['id']));?>">未通过</a>
