...
<body>
	<div class="wrap J_check_wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Jsfadmin/index');?>">开发商保证金管理</a></li>
			<li><a href="<?php echo U('Jsfadmin/add');?>">添加保证金</a></li>
		</ul>
		<form name="myform" action="<?php echo U('Jsfadmin/index');?>" method="post">
				...
				<thead>
					<tr>
						...
						<th align="left">缴纳银行</th>
                                            ...
                                            <th align="left">备注</th>
                                             <th width="50" align="left">审核</th>
						<th width="120">操作</th>
					</tr>
				</thead>
				<tbody>
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): if(!$vo['shenhe']=='0'){ if($vo['shenhe']=='1'){ $aa = '审核通过'; }else if($vo['shenhe']=='2'){ $aa = '审核未通过'; } }else{ $aa = '未审核'; } ?>
					<tr>
						...
						<td> 
								...
								<a href="<?php echo U('Jsfadmin/edit',array('id'=>$vo['id']));?>" id="change" >修改</a> |
							<a class="J_ajax_del" href="<?php echo U('Jsfadmin/delete',array('id'=>$vo['id']));?>">删除</a>
