...
<div class="wrap">
  ...
  <ul class="nav nav-tabs">
            <li class="active"><a href="<?php echo U('Admin/Main/index_xm');?>">项目标段模块</a></li>
            <li><a href="<?php echo U('Admin/Main/index_bzj');?>">保证金模块</a></li>
            <li ><a href="<?php echo U('Admin/Main/index');?>">其他模块</a></li>
        </ul>
