...
<![endif]-->
<link rel="stylesheet" href="/zjw/statics/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/zjw/statics/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				<a href="/zjw/index.php?g=admin&m=index&a=index" class="brand"> <small> 
				<img src="/zjw/statics/images/icon/logo-18.png">
						东营区建设领域农民工工资管理系统
				</small>
				</a>
				<div class="pull-left nav_shortcuts" >
					
					<a class="btn btn-small btn-warning" href="/zjw/" title="前台首页" target="_self">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="/zjw/statics/images/icon/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>">
						...
						<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
							<?php if(sp_auth_check(sp_get_current_admin_id(),'admin/setting/site')): ?><!--
								<li><a href="javascript:openapp('<?php echo U('setting/site');?>','index_site','站点管理');"><i class="fa fa-cog"></i> 站点管理</a></li>--><?php endif; ?>
	...
	<script src="/zjw/tpl_admin/simpleboot/assets/js/index.js"></script>
