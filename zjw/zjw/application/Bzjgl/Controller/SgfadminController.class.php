...
class SgfadminController extends AdminbaseController {
    ...
    function index(){  
        ...
        $forms = $Form
            ->field('sp_sgfbzj.id,sp_sgfbzj.projectid,sp_sgfbzj.bdmc,sp_sgfbzj.yhzh,sp_sgfbzj.gczzj,sp_sgfbzj.bzjbl,sp_sgfbzj.nmggzffbl,sp_sgfbzj.bzjje,sp_sgfbzj.bzjjnsj,
                sp_sgfbzj.bz,
                sp_projects.projectname as xmmc,sp_org.dwqc as ssyhmc,sp_construction.yhzh as ssyhzh,sp_construction.dwqc as sgfmc,sp_company.dwqc as jsfmc')
            ->join('LEFT JOIN sp_projects ON sp_sgfbzj.projectid=sp_projects.id')
            ...
            ->where('')->order("sp_sgfbzj.id")->limit($page->firstRow . ',' . $page->listRows)->select();
