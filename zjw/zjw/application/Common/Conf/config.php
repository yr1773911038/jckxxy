...
$configs= array(
		...
		'APP_GROUP_LIST'        => 'Admin,Portal,Asset,Api,Member,Wx,Toptic,Strap,Gzgl,Jcsj,Bzjgl',      // 项目分组设定,多个组之间用逗号分隔,例如'Home,Admin'
		'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Api','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay','Gzgl','Jcsj','Bzjgl','Sfgl'),
